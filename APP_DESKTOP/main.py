...
class Login:
    ...
    def __init__(self,ventana_login):
        ...
        "--------------- Loginlogo --------------------"
        imagen_login=Image.open("C:/Users/mario/Desktop/APP_DESKTOP/Imagenes/login.png")
    ...
    def Ventana_registrar_usuario(self):
        ...
        "--------------- Nuevo usuario logo --------------------"
        imagen_registro=Image.open("C:/Users/mario/Desktop/APP_DESKTOP/Imagenes/nuevo_usuario.png")
